...
// -------------------------------------------------------------------------
// Sub-components (outside to maintain focus and state stability)
// -------------------------------------------------------------------------
                  ...
                  {isExpanded && (
                    <div className="mt-5 space-y-3 pt-4 border-t border-slate-50 animate-in fade-in zoom-in duration-200">
                      ...
                      <div className="flex gap-2 mt-3">
                        ...
                        />
                        <button onClick={() => addSubTask(task.id)} className="bg-sky-500 text-white p-2 rounded-xl hover:bg-sky-600">
                          <Plus size={14} />
                        </button>
                      </div>
                    </div>
